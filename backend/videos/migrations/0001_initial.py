    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='filters.source')),
            ],
        ),
        migrations.CreateModel(
            name='ImagePreview',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.IntegerField(choices=[(0, 'Not Checked'), (1, 'Qualitative'), (2, 'Non Qualitative')], default=0)),
                ...
                ('tags', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='filters.tag')),
